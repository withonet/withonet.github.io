...
var atiPic = 0;
var atiPix = ["resources/images/ati2.JPG", "resources/images/ati3.JPG", "resources/images/ati9.JPG", "resources/images/ati4.JPG", "resources/images/ati5.JPG", "resources/images/ati6.JPG", "resources/images/ati7.JPG", "resources/images/ati8.JPG", "resources/images/ati1.JPG"];
...
var wtwcPic = 0;
var wtwcPix = ["resources/images/wtwc3.JPG", "resources/images/wtwc2.JPG", "resources/images/wtwc1.JPG", "resources/images/wtwc4.JPG", "resources/images/wtwc5.JPG"];
...
var monotonistPic = 0;
var monotonistPix = ["resources/images/monotonist1.JPEG", "resources/images/monotonist2.JPEG", "resources/images/monotonist3.JPEG", "resources/images/monotonist4.JPG", "resources/images/monotonist5.JPEG", "resources/images/monotonist6.JPG"];

var ladyPic = 0;
var ladyPix = ["resources/images/lady1.JPG", "resources/images/lady2.JPG", "resources/images/lady4.JPG", "resources/images/lady3.JPG", "resources/images/lady5.JPG"];

function initLinks() {
    if (document.getElementById("atiPrev")) {
        document.getElementById("atiPrev").onclick = atiPrevious;
        document.getElementById("atiNext").onclick = atiNext;
    }
    ...
    if (document.getElementById("wtwcPrev")) {
        document.getElementById("wtwcPrev").onclick = wtwcPrevious;
        document.getElementById("wtwcNext").onclick = wtwcNext;
    }
    ...
    if (document.getElementById("monotonistPrev")) {
        document.getElementById("monotonistPrev").onclick = monotonistPrevious;
        document.getElementById("monotonistNext").onclick = monotonistNext;
    }
    if (document.getElementById("ladyPrev")) {
        document.getElementById("ladyPrev").onclick = ladyPrevious;
        document.getElementById("ladyNext").onclick = ladyNext;
    }
    if (document.getElementById("medeaPrev")) {
        document.getElementById("medeaPrev").onclick = medeaPrevious;
        document.getElementById("medeaNext").onclick = medeaNext;
    }
...
function wtwcPrevious() {
    if (wtwcPic == 0) {
        wtwcPic = wtwcPix.length;
    }
    wtwcPic--;
    document.getElementById("wtwcMain").src = wtwcPix[wtwcPic];
    return false;
}

function wtwcNext() {
    wtwcPic++;
    if (wtwcPic == wtwcPix.length) {
        wtwcPic = 0;
    }
    document.getElementById("wtwcMain").src = wtwcPix[wtwcPic];
    return false;
...
function monotonistPrevious() {
    if (monotonistPic == 0) {
        monotonistPic = monotonistPix.length;
    }
    monotonistPic--;
    document.getElementById("monotonistMain").src = monotonistPix[monotonistPic];
    return false;
}

function monotonistNext() {
    monotonistPic++;
    if (monotonistPic == monotonistPix.length) {
        monotonistPic = 0;
    }
    document.getElementById("monotonistMain").src = monotonistPix[monotonistPic];
    return false;
...
function atiPrevious() {
    if (atiPic == 0) {
        atiPic = atiPix.length;
    }
    atiPic--;
    document.getElementById("atiMain").src = atiPix[atiPic];
    return false;
}

function atiNext() {
    atiPic++;
    if (atiPic == atiPix.length) {
        atiPic = 0;
    }
    document.getElementById("atiMain").src = atiPix[atiPic];
    return false;
...
function ladyPrevious() {
    if (ladyPic == 0) {
        ladyPic = ladyPix.length;
    }
    ladyPic--;
    document.getElementById("ladyMain").src = ladyPix[ladyPic];
    return false;
}

function ladyNext() {
    ladyPic++;
    if (ladyPic == ladyPix.length) {
        ladyPic = 0;
    }
    document.getElementById("ladyMain").src = ladyPix[ladyPic];
    return false;
...
function medeaPrevious() {
    if (medeaPic == 0) {
        medeaPic = medeaPix.length;
    }
    medeaPic--;
    document.getElementById("medeaMain").src = medeaPix[medeaPic];
    return false;
}

function medeaNext() {
    medeaPic++;
    if (medeaPic == medeaPix.length) {
        medeaPic = 0;
    }
    document.getElementById("medeaMain").src = medeaPix[medeaPic];
    return false;
